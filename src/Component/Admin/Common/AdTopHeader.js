                    ...
                    <ul className="navbar-nav navbar-align">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <a className="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <LazyLoadImage effect='blur' src="assets/img/avatars/avatar.jpg" className="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span className="text-dark">{authData?.userResponse?.firstName + " " + authData?.userResponse?.lastName}</span>
                            </a>
