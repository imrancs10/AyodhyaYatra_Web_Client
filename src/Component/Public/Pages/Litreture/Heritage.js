...
export default function Heritage() {
    ...
    useEffect(() => {
        Api.Get(apiUrls.masterDataController.getMasterData + `?masterDataType=17`)
            .then(res => {
    ...
    return (
        <>
            <section className="wrapper bodyWrapper">
                <div className="container">
                    ...
                    <div className="inbanner-Ashta">
                        ...
                        <BreadCrumb option={[{ name: t('Heritagesite') }, { name: selectGhatData[`${langType}Name`] }]}></BreadCrumb>
                            ...
                            <div className="col-md-12">
                                <div className="row">
                                    <div className='col-6'>
                                        ...
                                        <h3 className='text-dark'>{t('listOfHeritageInVaranasi')}</h3>
                                        <hr />
                    ...
                    <div id="post-3371" className="post-3371 page type-page status-publish hentry">
                        <div className="pphead mt-3">
                            <h2>{t('HeritagesitesinVaranasi')}</h2>
                        </div>
            ...
            <div className='row'>
                {
                    ghatData?.map((res, index) => {
                        return <GalleryTile onClickHandler={ChangeGhat} data={res} category="heritage" link={`#/TouristGuideDetails?masterDataId=${res?.id}`} key={index} moveTopOnClick={true} scrollPosition={500}/>
                    })
                }
            </div>
