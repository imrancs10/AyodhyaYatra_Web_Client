                ...
                <div className="row breadcrumb-outer">
                    <div className="left-content push-left">
                        <div id="breadcam" role="navigation" aria-label="breadcrumb">
                            <ul className="breadcrumbs"><li><a href="#/" className="home"><span>{t("home")}</span></a></li><li><a href="#">{t("quickLinks")}</a></li> <li className="current">{t("faqs")}</li></ul>
                        </div>
                    </div>
                ...
                <div className="row">
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div>
                                <hr />
                                <h4>{t("linkstoexternalwebsitesportals")}</h4>
                                <p style={{textAlign:'Justify'}}>
                                {t("p1linkstoexternalwebsitesportals")}
                                </p>
                                <hr />
                                <h4>{t("linkstoDepartmentofUPTourismWebsitebyotherwebsites/portals")}</h4>
                                <p style={{textAlign:'Justify'}}>
                                {t("p1linkstoDepartmentofUPTourismWebsitebyotherwebsites/portals")}
                                </p>
                            </div>
                            <div className="col-12">
