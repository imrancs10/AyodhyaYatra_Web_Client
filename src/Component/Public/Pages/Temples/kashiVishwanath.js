					...
					<div className="row breadcrumb-outer">
						<div className="left-content push-left">
							<div id="breadcam" role="navigation" aria-label="breadcrumb">
								<ul className="breadcrumbs"><li><a href="#" className="home"><span>Home</span></a></li> <li><a href="#tourism/">Tourism</a></li><li><a href="#tourist-places/" ><span>Tourist Places</span></a></li> <li className="current">Kashi Vishwanath Temple</li></ul>            </div>
						</div>
                ...
                <ul className="">
					...
					<div className="row">
						<div className="">
							...
							<div className="col-12">
								<div className="show-category"><strong>Category</strong> <em className="fa fa-angle-right"></em> <span>Religious Place</span></div>
							</div>
							<div className="col-6">
								<p style={{ textAlign: 'justify' }}><b>Kashi Vishwanath Temple</b> is a famous Hindu temple dedicated to Lord Shiva. It is located in Vishwanath Gali, near Varanasi, Uttar Pradesh, India. It is one of the most sacred pilgrimage sites for Hindus and is among the twelve Jyotirlinga, shrines which are said to be the most sacred abodes of Shiva. The temple stands on the western bank of the holy river Ganga and is one of the twelve Jyotirlingas.</p>

								<h2 className="heading3">Contact Details</h2>
								<p><strong>Email: </strong> <span className="word-break">abc[at]email[dot]com</span> </p>
								<p><strong>Address: </strong> 3rd Floor, Dummy Building, Dummy Road, Dummy Nagar, Varanasi, Uttar Pradesh. </p>
								<p><strong>Website URL: </strong> <a href="https://shrikashivishwanath.org/" className="word-break">https://shrikashivishwanath.org/ </a></p>                                                                                                                            <p><strong>Location: </strong> <a href="https://www.google.com/maps/dir//27.1750 ° N,78.0422 ° E" target="_blank"><i className="fa fa-location-arrow"></i> Map</a></p>
								<div id="photoGallery4">
									...
									<div id="slider" className="flexslider single-turistplc-glry">
										<ul className="slides">
											<li> <LazyLoadImage effect='blur' src="https://www.thehistoryhub.com/wp-content/uploads/2017/03/Kashi-Vishwanath-Temple.jpg" />
												<div className="slide-caption">
													काशी विश्वनाथ मंदिर 										</div>
											</li>
								...
								<div className="reachContainer clearfix">
									...
									<div className="txtContainer">
										...
										<p style={{ textAlign: 'justify' }}>
											The nearest airport to Kashi Vishwanath Temple lies at Varanasi - the cultural capital of India. Varanasi Airport at Babatpur is located about 30 km from Sarnath.
