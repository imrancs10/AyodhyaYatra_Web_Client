                ...
                <div className="container">
                    <div className="row breadcrumb-outer">
                        <div className="left-content push-left">
                            <div id="breadcam" role="navigation" aria-label="breadcrumb">
                                <ul className="breadcrumbs"><li><a href="#" className="home"><span>Home</span></a></li> <li><a href="#tourism/">Tourism</a></li><li><a href="#tourist-places/" ><span>Tourist Places</span></a></li> <li className="current">Banaras Hindu University </li></ul>            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="">
                            ...
                            <div className="col-6">
                                <p><b>Banaras Hindu University</b> is a place located 10 kilometres north-east of Varanasi near the confluence of the Ganges and the Varuna rivers in Uttar Pradesh, India. The deer park in<b>Sarnath</b> is where Gautama Buddha first taught the Dhamma, and where the Buddhist Sangha came into existence through the enlightenment of Kondanna.</p>


                                <h2 className="heading3">Contact Details</h2>                                                                                                                                                              <p><strong>Email: </strong> <span className="word-break">abc[at]email[dot]com</span> </p>                                                                                                                            <p><strong>Address: </strong> 3rd Floor, Dummy Building, Dummy Road, Dummy Nagar, Varanasi, Uttar Pradesh. </p>                                                                                                                            <p><strong>Website URL: </strong> <a href="https://www.bhu.ac.in/Site/Home/1_2_16_Main-Site" className="word-break">https://www.bhu.ac.in/Site/Home/1_2_16_Main-Site </a></p>                                                                                                                            <p><strong>Location: </strong> <a href="https://www.google.com/maps/dir//27.1750 ° N,78.0422 ° E" target="_blank"><i className="fa fa-location-arrow"></i> Map</a></p>
                                ...
                                <div id="photoGallery4">
                                    ...
                                    <div id="slider" className="flexslider single-turistplc-glry">
                                        <ul className="slides">
                                            <li> <LazyLoadImage effect='blur' src="https://farm5.staticflickr.com/4465/37660084182_28cf7a697e_b.jpg " />
                            ...
                            <div className="col-6">
                                ...
                                <div className="reachContainer clearfix">
                                    ...
                                    <div className="txtContainer">
                                        <h4>By Air </h4>
                                        <p>The nearest airport to BHU lies at Varanasi - the cultural capital of India. Varanasi Airport at Babatpur is located about 30 km from Sarnath.

                                            It is one of the important domestic airports in India. Almost all public and private airlines in India operate regular flights to and from Varanasi. From Varanasi you can avail direct flights to cities like Delhi, Mumbai, Khajuraho, and others. You can also board flight from Kathmandu to reach Varanasi.</p>
                                    </div>
                                </div>
                                <div className="reachContainer clearfix">
                                    <div className="iconContainer">
